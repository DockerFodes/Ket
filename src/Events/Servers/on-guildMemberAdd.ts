...
module.exports = class guildMemberAdd extends Event {
    ...
    public async on(guild: Guild, member: Member) {
        ...
        const
            ...
            background = await Canvas.loadImage(backgrounds[Math.floor(Math.random() * backgrounds.length)]),
